...
export default function SubmitTask() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus("success");
        setResult({ progress: data.progress, fileUrl: data.fileUrl });
      } else {
        setStatus("error");
          ...
          {status === "success" && result ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10 text-center">
              ...
              <p className="text-gray-500 text-sm mb-1">
                AI estimated your completion at <strong style={{ color: barColor }}>{result.progress}%</strong>.
              </p>
              <p className="text-gray-400 text-xs mb-6">HR has been notified with your submission.</p>

              <a
                href={result.fileUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block text-sm text-pink-600 hover:text-pink-700 font-medium border border-pink-200 hover:bg-pink-50 px-4 py-2 rounded-lg transition-colors"
              >
                View on GitHub →
              </a>
            </div>
            ...
            <>
              <div className="mb-7">
                ...
                <p className="text-gray-500 mt-1 text-sm">
                  Upload your completed task file. HR will be notified automatically.
                </p>
              </div>
                      ...
                      {file ? (
                        ...
                        <>
                          ...
                          <p className="text-sm text-gray-600">
                            Drag & drop or <span className="text-pink-600 font-medium">browse</span>
                          </p>
              ...
              <p className="text-center text-xs text-gray-400 mt-5">
                Your file will be uploaded securely and HR will be notified automatically.
              </p>
            </>
          )}
        </div>
